...
final class RequireBoundTest
{
            ...
            final Function<T1, T2> get)
    {
        ...
        list.stream().forEach(bound -> list.stream().filter(value -> get.apply(value).compareTo(get.apply(bound)) >= 0).forEach(value -> assertEquals(value, requireGreaterThanOrEqual(value, get, get.apply(bound), "paramterName", "fieldName"))));
        list.stream().forEach(bound -> list.stream().filter(value -> get.apply(value).compareTo(get.apply(bound)) > 0).forEach(value -> assertEquals(value, requireGreaterThan(value, get, get.apply(bound), "paramterName", "fieldName"))));
        ...
        list.stream().forEach(boundMinimum -> list.stream().forEach(boundMaximum -> list.stream().filter(value -> get.apply(value).compareTo(get.apply(boundMinimum)) > 0 && get.apply(value).compareTo(get.apply(boundMaximum)) < 0).forEach(value -> assertEquals(value, requireBoundExclusive(value, get, get.apply(boundMinimum), get.apply(boundMaximum), "parmaeterName", "fieldName")))));
        list.stream().forEach(boundMinimum -> list.stream().forEach(boundMaximum -> list.stream().filter(value -> get.apply(value).compareTo(get.apply(boundMinimum)) >= 0 && get.apply(value).compareTo(get.apply(boundMaximum)) <= 0).forEach(value -> assertEquals(value, requireBoundInclusive(value, get, get.apply(boundMinimum), get.apply(boundMaximum), "parmaeterName", "fieldName")))));
